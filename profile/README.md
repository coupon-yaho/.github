<div align="center">
  <img src="../assets/logo-main.png" alt="쿠폰 야호~" width="650"/>
  <h1>쿠폰 야호~</h1>
...
**쿠폰 야호~**는 병목을 측정하고 구조를 단계적으로 발전시켰습니다. MySQL 동시성 제어에서 시작해 Redis 원자 재고 선점과 적응형 대기열을 구현했으며, Kafka 기반 비동기 영속화는 다음 단계의 설계안으로 정리했습니다.
...
<table>
  ...
  <tbody>
    <tr>
      <td><b>Frontend</b></td>
      <td>React · Vite · Bun · TanStack Query · NGINX</td>
    </tr>
    <tr>
      <td><b>Backend</b></td>
